...
export const getUserforSidebar=async(req,res)=>{
    try{
        ...
        const promises=filteredUser.map(async(user)=>{
            // we will get here all the unseen messages
...
export const sendMessage=async(req,res)=>{
    try{
        ...
        const newMsg=await Message.create({senderId,receiverId,text,image:imageUrl});
        
        // Emit the new messag eto the receiver's socket
